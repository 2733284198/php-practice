...
#ffmpeg -i $FILE -c:v libx264 -b:v 300k -c:a libfdk_aac -b:a 64k  -f flv rtmp://10.117.19.148/live/${NODE_STREAM_ID} &
#ffmpeg -i $FILE -c:v libx264 -b:v 500k -c:a libfdk_aac -b:a 64k  -f flv rtmp://10.117.19.148/hls/${NODE_STREAM_ID}_hi &
#ffmpeg -i $FILE -c:v libx264 -b:v 100k -c:a libfdk_aac -b:a 64k  -f flv rtmp://10.117.19.148/hls/${NODE_STREAM_ID}_low &
