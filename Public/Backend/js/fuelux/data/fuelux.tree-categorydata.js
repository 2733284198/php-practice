...
var tree_data = {
	'for-sale' : {name: '衣服', type: 'folder'}	,
	'vehicles' : {name: '鞋子', type: 'folder'}	,
	'rentals' : {name: '玩具', type: 'folder'}	,
	'real-estate' : {name: '家具', type: 'folder'}	,
	'pets' : {name: '汽车', type: 'folder'}	,
...
tree_data['for-sale']['additionalParameters'] = {
	'children' : {
		'appliances' : {name: '西服', type: 'item'},
		'arts-crafts' : {name: '学士服', type: 'item'},
		'clothing' : {name: '儿童服装', type: 'item'},
		'computers' : {name: '流行衣服', type: 'item'},
	}
}
